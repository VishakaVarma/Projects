 ...
 * @author vish1
 */
public class ViewResultsPatient extends javax.swing.JPanel {

    /**
     * Creates new form ViewResultsPatient
     */
    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private CancerLabWorkRequest request;
    private CancerLabOrganization cancerLabOrganization;
    private Enterprise enterprise;
    public ViewResultsPatient(JPanel userProcessContainer, CancerLabWorkRequest request, UserAccount userAccount) {
        initComponents();
    ...
    public void populateParameters(){
        rbcText.setText(String.valueOf(request.getRbc()));
        wbcText.setText(String.valueOf(request.getWbc()));
        plateletText.setText(String.valueOf(request.getPlateletCount()));
    }
